...
child = pexpect.spawn('ltcwallet --simnet --username=xu --password=xu --create')
...
os.system('ltcd --simnet --txindex --rpcuser=xu --rpcpass=xu --nolisten &')

time.sleep(5)

os.system('ltcwallet --simnet --username=xu --password=xu &')

time.sleep(5)

os.system('ltcctl --simnet --rpcuser=xu --rpcpass=xu --wallet walletpassphrase "xu" 600')
os.system('ltcctl --simnet --rpcuser=xu --rpcpass=xu --wallet getnewaddress > /miningaddr')
